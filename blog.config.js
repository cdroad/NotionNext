...
const BLOG = {
  AUTHOR: 'Mr.robot.ki', // 作者
  BIO: '生命游戏,游戏生命', // 作者简介
  LINK: 'https://notion-next-sigma.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客,嵌入式,计算机科学', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'c9f7dbf27e2e408da8367b08b68d9f46', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'lucienxf@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/aron-xx',
  CONTACT_TELEGRAM: '',
